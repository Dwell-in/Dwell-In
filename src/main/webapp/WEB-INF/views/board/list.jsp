...
<div class="container py-5">
    ...
    <!-- 검색 폼 -->
    <form class="row mb-4" action="${root }/api/v1/board/board-search" method="get" id="search-form">
        <input type="hidden" name="action" value="pattern-counting" />
        <input type="hidden" id="currentPage" name="currentPage" value="1" />
        <div class="d-flex justify-content-end align-items-center gap-2">
            <input type="text" class="form-control w-25" name="search" placeholder="제목 검색">
        ...
        <c:forEach items="${boardList}" var="item">
            <tr>
                ...
                <td class="text-start ps-4">
                    <a href="${root}/api/v1/board/board-detail/${item.boardId}" class="text-decoration-none text-dark">
                            ${item.title}
                    </a>
                </td>
